...
#pdf(paste0("~/Documents/Work/Postdoc/projects/Myeloid/results/cytogenetics/coocurrence/",Sys.Date(),"-Interaction_",Dataset.type,".pdf"), width=19, height=9, pointsize=8) 
...
#
M[upper.tri(M, diag=TRUE)] <- as.numeric(cut(pairs[o,o][upper.tri(M, diag=TRUE)]*nrow(genomicData), breaks=c(-1,0,5,10,20,50,100,200,600))) + 9 # TODO: Look at how many points
